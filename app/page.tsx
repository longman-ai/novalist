...
const services = [
  {
    ...
    description: 'Always-on marketing systems that compound — not chaotic one-off campaigns.',
    features: [
      'Evergreen campaigns: SEO → lead magnet → email nurture → bookings',
      '2-3 always-on funnels per audience segment',
      'Seasonal and news content plugs into existing structures',
  ...
  },
  {
    ...
    description: 'LinkedIn presence, intent signals, and personalised outreach — the right message at the right time.',
    features: [
      'AI-powered LinkedIn presence: contextual comments and posts on your behalf',
      'Buying signal monitoring: Companies House, job posts, review velocity',
      'Personalised outreach triggered when prospects are in growth mode',
      'Engagement-to-lead tracking in your CRM',
    ],
    href: '/services/lead-generation',
  },
  {
    title: 'Automation Infrastructure',
    description: 'Eliminate repetitive work and build intelligent systems that scale with your business.',
    features: [
